CPP = g++
SRC = ./src/
SOURCES = main.cpp application.cpp window.cpp log.cpp global_events.cpp monitor.cpp window_events.cpp image.cpp stb_image.cpp key_events.cpp key_input.cpp key_combo.cpp mouse_events.cpp mouse_input.cpp
